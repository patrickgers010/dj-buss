...
class Post {
  ...
  static List<Post> get samples => [
    Post(
      ...
      type: PostType.video,
      mediaUrl: null,
      caption: 'ONDRSTRM Edition 3 is coming 🔥 Wie is er klaar? #ONDRSTRM #Ondrstrm',
      tags: ['ONDRSTRM', 'Ondrstrm', 'Splintr'],
      likeCount: 234,
      commentCount: 47,
      shareCount: 88,
      createdAt: DateTime.now().subtract(const Duration(hours: 3)),
      linkedEventId: 'ondrstrm-3',
    ),
    Post(
      id: 'post-2',
      authorId: 'ondrstrm',
      ...
      authorImageUrl: '',
      type: PostType.image,
      caption: 'Tickets voor ONDRSTRM Ed. 3 druppelen binnenkort. Stay tuned! 🎟️',
      tags: ['ONDRSTRM', 'Tickets'],
      likeCount: 189,
      commentCount: 32,
      shareCount: 67,
    ...
    Post(
      ...
      authorImageUrl: '',
      type: PostType.video,
      caption: 'Studio sessie — nieuwe mix komt eraan 🎧 #RoMinimal #Splintr',
      tags: ['RoMinimal', 'Splintr', 'Studio'],
      likeCount: 312,
      commentCount: 58,
      shareCount: 102,
