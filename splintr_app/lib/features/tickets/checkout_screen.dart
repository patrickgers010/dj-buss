...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  TicketType get _ticket => TicketType.samplesOndrstrm3.firstWhere(
        (t) => t.id == widget.ticketTypeId,
        orElse: () => TicketType.samplesOndrstrm3.first,
      );
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Je $_quantity ${_ticket.name} ticket${_quantity > 1 ? "s zijn" : " is"} gereserveerd voor ONDRSTRM Edition 3. Bekijk je tickets in de app.',
                  ...
                  const SizedBox(height: AppSpacing.md),
                  NeonButton(
                    label: 'Terug naar ONDRSTRM',
                    variant: NeonButtonVariant.outline,
                    fullWidth: true,
                    onPressed: () => context.go(AppRoutes.ondrstrmEvent),
                  ),
                ],
              ),
            ),
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        height: 44,
                        decoration: BoxDecoration(
                          gradient: AppColors.gradientOndrstrm,
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('ONDRSTRM Edition 3 — ${_ticket.name}',
