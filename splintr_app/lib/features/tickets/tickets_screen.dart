...
class TicketsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tickets = TicketType.samplesOndrstrm3;
          ...
          Container(
            ...
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 4),
                Text('ONDRSTRM Edition 3', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 24, letterSpacing: -0.5)),
                SizedBox(height: 6),
