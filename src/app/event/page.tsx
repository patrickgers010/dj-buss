...
export const metadata: Metadata = {
  title: "ONDRSTRM – Event",
  description: "ONDRSTRM – The ultimate underground party experience with SPL!NTR.",
};

const lineup = [
  { name: "SPL!NTR", role: "Headliner", time: "22:00 – 00:00", highlight: true },
...
const faqs = [
  {
    q: "Where is ONDRSTRM taking place?",
  ...
  },
  {
    ...
    a: "ONDRSTRM is an 18+ event. Valid ID required on entry.",
  },
  {
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-4 py-20">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-400 text-lg max-w-lg mx-auto leading-relaxed mb-4">
            No show, no glitter, no hype. Just SPL!NTR + special guests, stripped-down sound, and a room full of people who get it.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-yellow-400 uppercase tracking-[0.3em] text-xs font-semibold mb-3">What is ONDRSTRM?</p>
            <h2 className="text-4xl font-black text-white mb-6">
              More than a party.<br />It&apos;s an undercurrent.
            </h2>
            <div className="space-y-4 text-gray-400 leading-relaxed">
              <p>
                <span className="text-white font-bold">ONDRSTRM</span> (Dutch for &ldquo;onderstroom&rdquo; — undercurrent) is the flagship event of the ecosystem — a full-on celebration of music, people, and the maat.
              </p>
              <p>
                Each edition raises the bar. New venue, tighter lineup, and a crowd that comes ready to move. ONDRSTRM has become one of the most anticipated nights on the calendar.
              </p>
              <p>
